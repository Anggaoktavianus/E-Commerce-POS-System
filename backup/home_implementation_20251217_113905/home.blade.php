        ...
        <div class="container py-5">
            <div class="row g-5 align-items-center">
                <div class="col-md-12 col-lg-7">
                    ...
                    <h1 class="mb-5 display-3 text-primary">{{ $settings['brand_name'] ?? 'Selamat Datang' }}</h1>
                    <form action="{{ route('shop') }}" method="GET" class="position-relative mx-auto">
                        ...
                        <button type="submit" class="btn btn-primary border-2 border-secondary py-3 px-4 position-absolute rounded-pill text-white h-100" style="top: 0; right: 25%;" aria-label="Tombol cari">
            ...
            <div class="tab-class text-center">
                <div class="row g-4">
                    <div class="col-lg-4 text-start">
                        <h1>{{ $siteSettings['homepage_products_title'] ?? 'Produk Kami' }}</h1>
                        ...
                        <div class="row g-4">
                            <div class="col-lg-12">
                                <div class="row g-4">
                                    @forelse($allProducts as $product)
                                        <div class="col-md-6 col-lg-4 col-xl-3">
                                            <div class="rounded position-relative fruite-item product-card bg-white border border-success border-2 shadow-sm d-flex flex-column h-100">
                                                ...
                                                <div class="text-white bg-secondary px-3 py-1 rounded position-absolute" style="top: 10px; left: 10px;">{{ $siteSettings['product_badge_text'] ?? 'Produk' }}</div>
                                                <div class="p-4 rounded-bottom d-flex flex-column flex-grow-1 text-start">
                                                    <h4>{{ $product->name }}</h4>
                                                    <p class="mb-2 text-muted">{{ $product->short_description ?? ($siteSettings['product_default_description'] ?? 'Produk segar dari Samsae.') }}</p>
                                                    @php
                                    ...
                                    @empty
                                        <div class="col-12 text-center py-4">{{ $siteSettings['no_products_found_text'] ?? 'Tidak ada produk ditemukan.' }}</div>
                                    @endforelse
                                </div>
                                    ...
                                    <div class="row g-4">
                                        ...
                                        @empty
                                            <div class="col-12 text-center py-5">
                                                <i class="bx bx-package bx-5x text-muted mb-3 d-block"></i>
                                                <p class="text-muted mb-3">{{ $siteSettings['no_category_products_text'] ?? 'Tidak ada produk di' }} kategori {{ $cat->name }}.</p>
                                                <a href="{{ route('shop') }}" class="btn btn-outline-primary">Lihat Semua Produk</a>
                                            </div>
                                        @endforelse
                                    </div>
                                </div>
    ...
    <div class="container-fluid py-5">
        <div class="container py-5">
            <div class="text-center mx-auto mb-5" style="max-width: 700px;">
                ...
                @else
                    <p>Produk terlaris pilihan pelanggan kami dengan kualitas terbaik dan harga terjangkau.</p>
                @endif
            </div>
            <div class="row g-4">
