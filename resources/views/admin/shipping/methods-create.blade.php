                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="code" name="code" value="{{ old('code') }}" required placeholder="contoh: gosend_instant">
                                    @error('code')
                                        <div class="text-danger small">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id="type" name="type" required>
                                        ...
                                        <option value="instant" {{ old('type') == 'instant' ? 'selected' : '' }}>Instan</option>
                                        <option value="same_day" {{ old('type') == 'same_day' ? 'selected' : '' }}>Same Day</option>
                                        ...
                                        <option value="pickup" {{ old('type') == 'pickup' ? 'selected' : '' }}>Ambil Sendiri</option>
                                    </select>
                                    @error('type')
                                        <div class="text-danger small">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="max_distance_km" name="max_distance_km" value="{{ old('max_distance_km') }}" placeholder="Untuk pengiriman instan">
