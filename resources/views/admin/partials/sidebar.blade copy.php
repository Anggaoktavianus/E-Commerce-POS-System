    ...
    <ul class="menu-inner py-1">
        ...
        <!-- <li class="menu-item {{ request()->routeIs('admin.products.*') ? 'active open' : '' }}">
            <a href="{{ route('admin.products.index') }}" class="menu-link d-flex align-items-center gap-2 text-decoration-none">
                ...
                <span>Produk</span>
                <span class="badge bg-label-success rounded-pill ms-auto">24</span>
            </a>
        </li> -->
        ...
        <!-- Store Management -->
        <li class="menu-item {{ request()->routeIs('admin.stores.*','admin.outlets.*','admin.products.*','admin.categories.*','admin.collections.*','admin.orders.*','admin.shipping.*') ? 'active open' : '' }}">
            ...
            <ul class="menu-sub">
                ...
                <li class="menu-item {{ request()->routeIs('admin.stores.stores','admin.stores.list','admin.stores.manage') ? 'active open' : '' }}">
        ...
        <!-- Navigation & Menu -->
        <li class="menu-item {{ request()->routeIs('admin.menus.*') ? 'active open' : '' }}">
            <a href="javascript:void(0);" class="menu-link menu-toggle d-flex align-items-center gap-2 text-decoration-none">
        ...
        <!-- Content Management -->
        <li class="menu-item {{ request()->routeIs('admin.features.index','admin.features.create','admin.features.edit','admin.testimonials.index','admin.testimonials.create','admin.testimonials.edit','admin.facts.index','admin.facts.create','admin.facts.edit','admin.social_links.index','admin.social_links.create','admin.social_links.edit') ? 'active open' : '' }}">
            <a href="javascript:void(0);" class="menu-link menu-toggle d-flex align-items-center gap-2 text-decoration-none">
        ...
        <!-- Media Management -->
        <li class="menu-item {{ request()->routeIs('admin.carousels.index','admin.carousels.create','admin.carousels.edit','admin.banners.index','admin.banners.create','admin.banners.edit','admin.collections.index','admin.collections.create','admin.collections.edit') ? 'active open' : '' }}">
            <a href="javascript:void(0);" class="menu-link menu-toggle d-flex align-items-center gap-2 text-decoration-none">
