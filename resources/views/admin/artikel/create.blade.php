    ...
    <div class="row">
          ...
          <div class="card-body">
            ...
            <div class="mb-3">
              ...
              <textarea class="form-control @error('meta_description') is-invalid @enderror" 
                        ...
                        placeholder="Meta description untuk SEO (maks 160 karakter)">{{ old('meta_description') }}</textarea>
      ...
      <div class="col-md-4">
        ...
        <div class="card">
          ...
          <div class="card-body">
            <ul class="mb-0 small">
              <li>Buat judul yang menarik dan SEO-friendly</li>
              <li>Gunakan heading tags (H1, H2, H3) untuk struktur konten</li>
              <li>Optimalisasi meta tags untuk search engine</li>
              <li>Upload gambar dengan ukuran optimal</li>
              <li>Review konten sebelum publish</li>
            </ul>
          </div>
        </div>
      </div>
        ...
        <div class="d-flex justify-content-between">
          ...
          <div>
            ...
            <button type="submit" class="btn btn-primary">
              <i class="bx bx-publish me-1"></i> Publish Artikel
            </button>
          </div>
        </div>
      </div>
