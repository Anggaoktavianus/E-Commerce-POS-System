    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.stores.stores.update', $store->id) }}">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="code" name="code" value="{{ old('code', $store->code) }}" required placeholder="Contoh: ABC001">
                                    @error('code')
                                        <div class="text-danger small">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="owner_name" name="owner_name" value="{{ old('owner_name', $store->owner_name) }}" required>
                                    @error('owner_name')
                                        <div class="text-danger small">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="tel" class="form-control" id="phone" name="phone" value="{{ old('phone', $store->phone) }}" required>
                                    @error('phone')
                                        <div class="text-danger small">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" id="address" name="address" rows="3" required>{{ old('address', $store->address) }}</textarea>
                                    @error('address')
                                        <div class="text-danger small">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="province" name="province" value="{{ old('province', $store->province) }}" required>
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="postal_code" name="postal_code" value="{{ old('postal_code', $store->postal_code) }}" required>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="tax_id" name="tax_id" value="{{ old('tax_id', $store->tax_id) }}" placeholder="Contoh: 12.345.678.9-012.345">
                                    @error('tax_id')
                                        <div class="text-danger small">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="business_license" name="business_license" value="{{ old('business_license', $store->business_license) }}" placeholder="Nomor SIUP">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="url" class="form-control" id="logo_url" name="logo_url" value="{{ old('logo_url', $store->logo_url) }}" placeholder="https://example.com/logo.png">
                                    @error('logo_url')
                                        <div class="text-danger small">{{ $message }}</div>
                                    @enderror
                                </div>
...
document.addEventListener('DOMContentLoaded', function(){
  ...
  const oldProv = '{{ old('loc_provinsi_id', $store->loc_provinsi_id) }}';
  const oldKab = '{{ old('loc_kabkota_id', $store->loc_kabkota_id) }}';
  const oldKec = '{{ old('loc_kecamatan_id', $store->loc_kecamatan_id) }}';
  const oldDesa = '{{ old('loc_desa_id', $store->loc_desa_id) }}';
