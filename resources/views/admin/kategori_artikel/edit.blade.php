        ...
        <div class="row">
          <div class="col-md-8">
            ...
            <div class="alert alert-info">
              <h6 class="alert-heading">
                <i class="bx bx-bar-chart me-2"></i>Statistik Kategori:
              </h6>
              <div class="row">
                <div class="col-md-4">
                  <strong>Total Artikel:</strong> {{ $kategoriArtikel->artikel_count }}
                </div>
                <div class="col-md-4">
                  <strong>Dibuat:</strong> {{ $kategoriArtikel->created_at->format('d M Y') }}
                </div>
                <div class="col-md-4">
                  <strong>Diperbarui:</strong> {{ $kategoriArtikel->updated_at->format('d M Y') }}
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-4">
              ...
              <div class="border rounded p-3 text-center bg-light">
                <div id="imagePreview" class="mb-3">
                  @if($kategoriArtikel->gambar)
                    <img src="{{ Storage::url($kategoriArtikel->gambar) }}" class="img-fluid rounded" style="max-height: 200px;" alt="Current Image">
                  @else
            ...
            <div class="alert alert-warning">
              ...
              <ul class="mb-0 small">
                <li>Perubahan nama akan mempengaruhi slug jika slug kosong</li>
                <li>Jika kategori memiliki artikel, pastikan perubahan tidak mempengaruhi struktur</li>
                <li>Menonaktifkan kategori tidak akan menghapus artikel di dalamnya</li>
              </ul>
            </div>
          </div>
        </div>
