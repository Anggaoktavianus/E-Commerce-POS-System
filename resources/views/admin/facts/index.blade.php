...
<div class="container-xxl flex-grow-1 container-p-y">
  ...
  <div class="card page-header-card mb-4">
    <div class="card-body">
      <div class="d-flex justify-content-between align-items-center flex-wrap">
        <div>
          <h4 class="mb-1">
            <i class="bx bx-bar-chart-alt me-2 text-primary"></i>Kelola Statistik & Fakta
          </h4>
          <p class="text-muted mb-0">Buat dan kelola statistik perusahaan untuk menampilkan pencapaian</p>
        </div>
        <a href="{{ route('admin.facts.create') }}" class="btn btn-primary btn-modern mt-2 mt-md-0">
        ...
        <div class="card-body p-4">
          <div class="d-flex justify-content-between align-items-start">
            <div class="flex-grow-1">
              <p class="stat-label mb-2">Total Statistik</p>
              <h3 class="stat-value mb-0" id="totalFacts">0</h3>
            </div>
            <div class="stat-icon">
        ...
        <div class="card-body p-4">
          <div class="d-flex justify-content-between align-items-start">
            <div class="flex-grow-1">
              ...
              <h3 class="stat-value mb-0" id="activeFacts">0</h3>
            </div>
            <div class="stat-icon">
        ...
        <div class="card-body p-4">
          <div class="d-flex justify-content-between align-items-start">
            <div class="flex-grow-1">
              ...
              <h3 class="stat-value mb-0" id="inactiveFacts">0</h3>
            </div>
            <div class="stat-icon">
    ...
    <div class="col-6 col-md-3">
      <div class="card stat-card bg-info text-white">
        <div class="card-body p-4">
          <div class="d-flex justify-content-between align-items-start">
            <div class="flex-grow-1">
              <p class="stat-label mb-2">Dengan Icon</p>
              <h3 class="stat-value mb-0" id="factsWithIcons">0</h3>
            </div>
            <div class="stat-icon">
  ...
  <div class="card card-modern">
    ...
    <div class="card-body table-responsive">
      <table class="table table-striped table-hover table-modern" id="facts-table">
        <thead>
          <tr>
            <th width="5%">No</th>
