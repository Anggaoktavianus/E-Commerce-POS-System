    ...
    <div class="admin-form-modern">
        <div class="admin-form-card">
            <div class="admin-form-header">
                <h3><i class="bx bx-store-alt me-2"></i>{{ $title }}</h3>
                <p>{{ $subtitle }}</p>
                </div>
            <div class="admin-form-body">
                    ...
                    <div class="form-section">
                        <h5><i class="bx bx-store-alt me-2"></i>Informasi Outlet</h5>
                        <hr>
                        
                        <div class="row g-3">
                            <div class="col-md-6">
                                <label for="store_id" class="form-label required-field">Toko</label>
                                <select class="form-select @error('store_id') is-invalid @enderror" id="store_id" name="store_id" required>
                                        <option value="">Pilih Toko</option>
                                        @foreach($stores as $store)
                                            <option value="{{ $store->id }}" {{ old('store_id', $outlet->store_id) == $store->id ? 'selected' : '' }}>
                            ...
                            <div class="col-md-6">
                                <label for="name" class="form-label required-field">Nama Outlet</label>
                                <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" value="{{ old('name', $outlet->name) }}" placeholder="Masukkan nama outlet" required>
                                    @error('name')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control @error('short_name') is-invalid @enderror" id="short_name" name="short_name" value="{{ old('short_name', $outlet->short_name) }}" placeholder="Contoh: Pandanaran" maxlength="20" required>
                            ...
                            <div class="col-md-6">
                                <label for="code" class="form-label required-field">Kode Outlet</label>
                                <input type="text" class="form-control @error('code') is-invalid @enderror" id="code" name="code" value="{{ old('code', $outlet->code) }}" placeholder="Contoh: ABC-SMG01" required>
                                    @error('code')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <label for="type" class="form-label required-field">Tipe Outlet</label>
                                <select class="form-select @error('type') is-invalid @enderror" id="type" name="type" required>
                                        <option value="">Pilih Tipe</option>
                                        <option value="main" {{ old('type', $outlet->type) == 'main' ? 'selected' : '' }}>Utama</option>
                                        <option value="branch" {{ old('type', $outlet->type) == 'branch' ? 'selected' : '' }}>Cabang</option>
                                        <option value="pickup_point" {{ old('type', $outlet->type) == 'pickup_point' ? 'selected' : '' }}>Pickup Point</option>
                                    </select>
                                    @error('type')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control @error('manager_name') is-invalid @enderror" id="manager_name" name="manager_name" value="{{ old('manager_name', $outlet->manager_name) }}" placeholder="Masukkan nama manajer">
                                    @error('manager_name')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="tel" class="form-control @error('phone') is-invalid @enderror" id="phone" name="phone" value="{{ old('phone', $outlet->phone) }}" placeholder="08123456789" required>
                                    @error('phone')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="email" class="form-control @error('email') is-invalid @enderror" id="email" name="email" value="{{ old('email', $outlet->email) }}" placeholder="email@example.com">
                                    @error('email')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                    ...
                    <div class="form-section">
                        ...
                        <div class="row g-3">
                            <div class="col-12">
                                ...
                                <textarea class="form-control @error('address') is-invalid @enderror" id="address" name="address" rows="3" placeholder="Jl. Contoh No. 123, RT/RW 001/002" required>{{ old('address', $outlet->address) }}</textarea>
                                @error('address')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control @error('province') is-invalid @enderror" id="province" name="province" value="{{ old('province', $outlet->province) }}" required>
                                @error('province')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                                </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control @error('city') is-invalid @enderror" id="city" name="city" value="{{ old('city', $outlet->city) }}" required>
                                @error('city')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control @error('postal_code') is-invalid @enderror" id="postal_code" name="postal_code" value="{{ old('postal_code', $outlet->postal_code) }}" required>
                                @error('postal_code')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                    ...
                    <div class="form-section">
                        ...
                        <small class="text-muted d-block mt-2">
                            <i class="bx bx-info-circle me-1"></i>
                            Gunakan GPS, cari alamat, atau klik pada peta untuk menentukan lokasi outlet. Pastikan marker berada di lokasi yang tepat.
                        </small>
                        <input type="hidden" id="latitude" name="latitude" value="{{ old('latitude', $outlet->latitude) }}">
                        <input type="hidden" id="longitude" name="longitude" value="{{ old('longitude', $outlet->longitude) }}">
                        @error('latitude')
                    ...
                    <!-- Informasi Tambahan -->
                    <div class="form-section">
                        <h5><i class="bx bx-time me-2"></i>Jam Operasional & Status</h5>
                        <hr>
                        ...
                        <div class="row g-3">
                                ...
                                <label class="form-label">Senin - Jumat</label>
                                                <div class="input-group">
                                                    <input type="time" class="form-control" name="operating_hours[weekdays][open]" value="{{ old('operating_hours.weekdays.open', $outlet->operating_hours['weekdays']['open'] ?? '08:00') }}">
                                                    <span class="input-group-text">s/d</span>
                                                    <input type="time" class="form-control" name="operating_hours[weekdays][close]" value="{{ old('operating_hours.weekdays.close', $outlet->operating_hours['weekdays']['close'] ?? '17:00') }}">
                                                </div>
                                            </div>
                                ...
                                <label class="form-label">Sabtu - Minggu</label>
                                                <div class="input-group">
                                                    <input type="time" class="form-control" name="operating_hours[weekend][open]" value="{{ old('operating_hours.weekend.open', $outlet->operating_hours['weekend']['open'] ?? '09:00') }}">
                                                    <span class="input-group-text">s/d</span>
                                                    <input type="time" class="form-control" name="operating_hours[weekend][close]" value="{{ old('operating_hours.weekend.close', $outlet->operating_hours['weekend']['close'] ?? '15:00') }}">
                                    </div>
                                </div>
                                
                            <div class="col-12">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="is_active" name="is_active" value="1" {{ old('is_active', $outlet->is_active) ? 'checked' : '' }}>
                                        <label class="form-check-label" for="is_active">
                                        <strong>Aktif</strong> - Outlet akan ditampilkan di sistem
                                        </label>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="action-buttons">
                            ...
                            <i class="bx bx-save me-1"></i>Update Outlet
                            </button>
                        </div>
                    </form>
            </div>
...
document.addEventListener('DOMContentLoaded', function(){
  ...
  const oldProv = '{{ old('loc_provinsi_id', $outlet->loc_provinsi_id ?? '') }}';
  const oldKab = '{{ old('loc_kabkota_id', $outlet->loc_kabkota_id ?? '') }}';
  const oldKec = '{{ old('loc_kecamatan_id', $outlet->loc_kecamatan_id ?? '') }}';
  const oldDesa = '{{ old('loc_desa_id', $outlet->loc_desa_id ?? '') }}';
  
  console.log('Loading location data:', { oldProv, oldKab, oldKec, oldDesa });
  ...
  fetch('{{ route('api.locations.provinsis') }}')
    .then(r => r.json()).then(json => {
      ...
      if (window.jQuery && $.fn.select2) { 
        ...
        if (oldProv) { 
          $prov.val(oldProv).trigger('change.select2'); 
          // Wait a bit for select2 to update, then load kabupaten
          setTimeout(function() {
  ...
  function loadKab(pid, restoring){
    ...
    fetch(`{{ url('/api/locations/kabkotas') }}/${pid}`).then(r=>r.json()).then(j=>{
      ...
      if (window.jQuery && $.fn.select2) { 
        ...
        $kab.select2({ width: '100%' }); 
        if(restoring && oldKab){ 
          // Set value and trigger change after Select2 is fully initialized
          setTimeout(function() {
            $kab.val(oldKab).trigger('change.select2');
            console.log('Set Kab/Kota value:', oldKab, 'Current value:', $kab.val());
            // Wait a bit more before loading kecamatan to ensure Select2 is updated
            setTimeout(function() {
              loadKec(oldKab, true);
            }, 150);
          }, 200);
  ...
  function loadKec(kid, restoring){
    ...
    fetch(`{{ url('/api/locations/kecamatans') }}/${kid}`).then(r=>r.json()).then(j=>{
      ...
      if (window.jQuery && $.fn.select2) { 
        ...
        $kec.select2({ width: '100%' }); 
        if(restoring && oldKec){ 
          $kec.val(oldKec).trigger('change.select2'); 
          // Wait a bit for select2 to update, then load desa
          setTimeout(function() {
  ...
  function loadDesa(did, restoring){
    ...
    fetch(`{{ url('/api/locations/desas') }}/${did}`).then(r=>r.json()).then(j=>{
      ...
      if (window.jQuery && $.fn.select2) { 
        ...
        $desa.select2({ width: '100%' }); 
        if(restoring && oldDesa){ 
          $desa.val(oldDesa).trigger('change.select2'); 
        }
      } else {
        if(restoring && oldDesa){ 
          $desa.val(oldDesa).trigger('change'); 
        }
      }
    });
  }
  // Initialize Select2 for all location selects
  $('#loc_provinsi_id, #loc_kabkota_id, #loc_kecamatan_id, #loc_desa_id').select2({ 
    width: '100%',
