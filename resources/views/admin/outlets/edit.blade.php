                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="name" name="name" value="{{ old('name', $outlet->name) }}" required>
                                    @error('name')
                                        <div class="text-danger small">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="code" name="code" value="{{ old('code', $outlet->code) }}" required placeholder="Contoh: ABC-SMG01">
                                    @error('code')
                                        <div class="text-danger small">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="manager_name" name="manager_name" value="{{ old('manager_name', $outlet->manager_name) }}">
                                    @error('manager_name')
                                        <div class="text-danger small">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="tel" class="form-control" id="phone" name="phone" value="{{ old('phone', $outlet->phone) }}" required>
                                    @error('phone')
                                        <div class="text-danger small">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="email" class="form-control" id="email" name="email" value="{{ old('email', $outlet->email) }}">
                                    @error('email')
                                        <div class="text-danger small">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" id="address" name="address" rows="3" required>{{ old('address', $outlet->address) }}</textarea>
                                    @error('address')
                                        <div class="text-danger small">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="province" name="province" value="{{ old('province', $outlet->province) }}" required>
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="city" name="city" value="{{ old('city', $outlet->city) }}" required>
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="postal_code" name="postal_code" value="{{ old('postal_code', $outlet->postal_code) }}" required>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" step="any" class="form-control" id="latitude" name="latitude" value="{{ old('latitude', $outlet->latitude) }}" placeholder="-7.7956">
                                            @error('latitude')
                                                <div class="text-danger small">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" step="any" class="form-control" id="longitude" name="longitude" value="{{ old('longitude', $outlet->longitude) }}" placeholder="110.3695">
                                            @error('longitude')
                                                <div class="text-danger small">{{ $message }}</div>
                                            @enderror
                                        </div>
