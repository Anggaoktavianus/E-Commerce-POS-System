        ...
        <div class="container topbar bg-primary d-none d-lg-block">
            <div class="d-flex justify-content-between">
                <div class="top-info ps-2">
                    <small class="me-3"><i class="fas fa-map-marker-alt me-2 text-secondary"></i> <a href="#" class="text-white">{{ $siteSettings['address'] ?? 'Address' }}</a></small>
                ...
                <div class="collapse navbar-collapse bg-white" id="navbarCollapse">
                    ...
                    <div class="d-flex m-3 me-0 align-items-center">
                        ...
                        <a href="{{ route('cart') }}" class="position-relative me-4 my-auto">
                            ...
                            <span class="position-absolute bg-secondary rounded-circle d-flex align-items-center justify-content-center text-dark px-1" style="top: -5px; left: 15px; height: 20px; min-width: 20px;">{{ count(session('cart', [])) }}</span>
                        </a>
                                ...
                                <ul class="dropdown-menu dropdown-menu-end">
                                    ...
                                    <li>
                                        <form method="POST" action="{{ route('logout') }}">
                                            @csrf
                                            <button type="submit" class="dropdown-item">{{ $siteSettings['nav_logout_text'] ?? 'Logout' }}</button>
                                        </form>
                                    </li>
                                </ul>
                            </div>
                        @else
                            <div class="dropdown my-auto">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end">
                                        <li><a class="dropdown-item" href="{{ route('login') }}">{{ $siteSettings['nav_login_text'] ?? 'Login' }}</a></li>
