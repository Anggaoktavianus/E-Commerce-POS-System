            ...
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <h1 class="h3 text-white mb-2">
                        <i class="bx bx-user-plus me-2"></i>Daftar Akun Customer
                    </h1>
            ...
            <div class="register-card">
                ...
                <div class="register-body">
                        ...
                        <div class="auth-section">
                            <h5><i class="bx bx-user me-2"></i>Informasi Pribadi</h5>
                            <hr>
                            
                            <div class="row g-3">
                                <div class="col-md-6">
                                    <label for="name" class="form-label required-field">{{ __('Nama Lengkap') }}</label>
                                ...
                                <div class="col-md-6">
                                    <label for="email" class="form-label required-field">{{ __('Alamat Email') }}</label>
                                        ...
                                        <div class="col-md-6">
                                    <label for="password" class="form-label required-field">{{ __('Password') }}</label>
                                        ...
                                        <div class="col-md-6">
                                    <label for="password-confirm" class="form-label required-field">{{ __('Konfirmasi Password') }}</label>
                                                <div class="input-group">
                                    ...
                                    <label for="phone" class="form-label">{{ __('Nomor Telepon/Whatsapp') }}</label>
                                                ...
                                                <small class="text-muted d-block mt-1">
                                                    <i class="bx bx-info-circle me-1"></i>
                                                    Masukkan nomor telepon/whatsapp aktif Anda
                                                </small>
                                            </div>

                                        <div class="col-md-6">
                                    <label for="address" class="form-label required-field">{{ __('Alamat Lengkap') }}</label>
                                    <textarea id="address" class="form-control @error('address') is-invalid @enderror" name="address" rows="3" placeholder="Jl. Contoh No. 123, RT/RW 001/002" required>{{ old('address') }}</textarea>
                        ...
                        <!-- Maps Picker -->
                        <div class="auth-section">
                            <h5><i class="bx bx-map me-2"></i>Pinpoint Lokasi di Peta</h5>
                            <hr>
                            ...
                            <div id="map" style="height: 400px; width: 100%; border-radius: 12px; border: 2px solid #e9ecef;"></div>
                            ...
                            @enderror
                                ...
                                <!-- Informasi Lokasi -->
                        <div class="auth-section">
                            <h5><i class="bx bx-map-pin me-2"></i>Informasi Lokasi</h5>
                                    <hr>
                            <div class="row g-3">
                                        <div class="col-md-6">
                                    <label class="form-label required-field">Provinsi</label>
                                        ...
                                        <div class="col-md-6">
                                    <label class="form-label required-field">Kab/Kota</label>
                        ...
                        <!-- Submit Button -->
                            ...
                            <button type="submit" class="btn btn-register">
                                <i class="bx bx-user-plus me-2"></i>{{ __('Daftar Sekarang') }}
                                </button>
                            </div>
                        </form>
                    </div>
