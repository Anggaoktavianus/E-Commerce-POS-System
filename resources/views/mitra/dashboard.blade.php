...
<div class="dashboard-wrapper">
    ...
    <div class="container-fluid page-header py-5" style="background: linear-gradient(135deg, #137440 0%, #0f5d33 100%);">
        <h1 class="text-center text-white display-6">Dashboard Mitra</h1>
        <ol class="breadcrumb justify-content-center mb-0">
            <li class="breadcrumb-item"><a href="{{ url('/') }}" class="text-white">Home</a></li>
            <li class="breadcrumb-item"><a href="#" class="text-white">Pages</a></li>
            <li class="breadcrumb-item active text-white">Dashboard Mitra</li>
        </ol>
    </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="stat-card slide-in" style="animation-delay: 0.1s;">
                    ...
                    @if(auth()->user()->is_verified ?? false)
                        <h4 class="text-success mb-2">Terverifikasi</h4>
                        <p class="text-muted small mb-0">Akses harga grosir aktif</p>
                    @else
                        <h4 class="text-warning mb-2">Menunggu Verifikasi</h4>
                        <p class="text-muted small mb-0">Akun sedang diverifikasi admin</p>
                    @endif
                </div>
            </div>
                    ...
                    <div class="row g-2">
                        <div class="col-6">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <span class="fw-bold">{{ $orderStats['pending'] }}</span>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="d-flex justify-content-between align-items-center">
                                <span class="status-badge bg-success">Paid</span>
                                <span class="fw-bold">{{ $orderStats['paid'] }}</span>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="d-flex justify-content-between align-items-center">
                                <span class="status-badge bg-info">Processing</span>
                                <span class="fw-bold">{{ $orderStats['processing'] }}</span>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="d-flex justify-content-between align-items-center">
                                <span class="status-badge bg-primary">Shipped</span>
                                <span class="fw-bold">{{ $orderStats['shipped'] }}</span>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="d-flex justify-content-between align-items-center">
                                <span class="status-badge bg-success">Delivered</span>
                                <span class="fw-bold">{{ $orderStats['delivered'] }}</span>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="d-flex justify-content-between align-items-center">
                                <span class="status-badge bg-secondary">Cancelled</span>
                                <span class="fw-bold">{{ $orderStats['cancelled'] }}</span>
                            </div>
                        </div>
                    </div>
                </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    $('#ordersTable').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: '{{ route("mitra.orders.datatables") }}',
            type: 'GET',
            data: function (d) {
