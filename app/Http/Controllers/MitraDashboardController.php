...
class MitraDashboardController extends Controller
{
    public function index()
    {
        ...
        // Debug logging
        \Log::info('Mitra Dashboard - User: ' . ($user ? $user->name : 'NULL') . ' (ID: ' . ($user ? $user->id : 'NULL') . ')');
        
        // Get mitra's orders data
        $orders = Order::where('user_id', $user->id);
        
        // Debug logging
        \Log::info('Mitra Dashboard - Orders count: ' . $orders->count());
        ...
        // Debug logging
        \Log::info('Mitra Dashboard - Recent orders count: ' . $recentOrders->count());
