    ...
    public function data()
    {
        ...
        return DataTables::of($kategori)
            ...
            ->addColumn('actions', function ($kategori) {
                return '
                    <a href="'.route('admin.kategori_artikel.edit', $kategori).'" class="btn btn-sm btn-warning" title="Edit">
                        <i class="bx bx-edit"></i>
                    </a>
                    <button type="button" class="btn btn-sm btn-danger" onclick="deleteItem('.$kategori->id.')" title="Delete">
